...
interface OnboardingScreen1Props extends InfoViewProps {
  currentPage: number;
  totalPages: number;
}

export default function OnboardingScreen1({ onNext, onSkip, isLastPage, currentPage, totalPages }: OnboardingScreen1Props) {
  return (

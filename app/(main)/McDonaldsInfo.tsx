...
export default function McDonaldsInfoScreen() {
      ...
      <ScrollView style={styles.scrollViewContent}>
        ...
        <View style={styles.infoNicaraguaContainer}>
          ...
          <Text style={styles.infoNicaraguaText}>
            McDonald&apos;s llegó a Nicaragua en 1995, abriendo su primer restaurante en Managua. Desde entonces, se ha consolidado como una de las cadenas de comida rápida preferidas en el país, ofreciendo un menú adaptado a los gustos locales, incluyendo opciones con productos frescos de la región. Actualmente, cuenta con 15 sucursales estratégicamente ubicadas en las principales ciudades, generando más de 800 empleos directos y apoyando a productores locales. Su compromiso con la comunidad se refleja en programas de responsabilidad social y eventos familiares.
          </Text>
        </View>

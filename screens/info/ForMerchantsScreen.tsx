...
export default function ForMerchantsScreen() {
  const navigation = useNavigation();

  const handleBackToStart = () => {
    navigation.navigate('UserBenefits' as never);
  };
    ...
    >
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.imageContainer}>
          <Image
            source={{ uri: 'https://api.a0.dev/assets/image?text=Store%20Employee%20Smiling&aspect=16:9' }}
